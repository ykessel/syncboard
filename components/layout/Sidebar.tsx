...
import { LayoutDashboard, LogOut, Plus, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-6 w-6 h-6 rounded-full bg-[#14141f] border border-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-colors"
      >
