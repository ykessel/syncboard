...
export default function LandingPage() {
    return (
        <div style={{
            ...
            {/* Ambient glow */}
            <div className="animate-glow-shift" style={{
                position: 'absolute',
                top: -260,
                left: '50%',
                ...
                width: 1100,
                height: 760,
                background: `radial-gradient(60% 60% at 50% 40%, rgba(124,108,246,.22), rgba(124,108,246,0) 70%)`,
                filter: 'blur(20px)',
                pointerEvents: 'none',
                zIndex: 0
            }}/>
                ...
                <div style={{
                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: 11}}>
                        <div style={{
                            ...
                            fontSize: 17,
                            color: '#fff',
                            boxShadow: '0 4px 16px rgba(124,108,246,.4)'
                        }}>S
                        </div>
                        <span style={{
                            fontFamily: 'var(--font-space-grotesk)',
                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: 16}}>
                        <Link href="/login" style={{fontSize: 14.5, color: muted2}}
                        ...
                        <Link href="/login" style={{
                            ...
                            boxShadow: '0 6px 20px rgba(124,108,246,.35)'
            ...
            <section style={{
                ...
                <div className="animate-reveal" style={{flex: 1, minWidth: 360}}>
                    <div style={{
                        ...
                        <span className="animate-pulse-green"
                    ...
                    <h1 style={{
                        ...
                        <span style={{
                            background: `linear-gradient(96deg,${accent},${accentBright})`,
                    ...
                    <p style={{fontSize: 18.5, lineHeight: 1.6, color: '#a3a3b6', maxWidth: 480, marginBottom: 34}}>
                        A real-time Kanban board where your whole team works live. Drag a card and everyone sees it move
                        — cursors, presence and edits, instantly. No refresh, ever.
                    </p>
                    ...
                    <div style={{display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 13, marginBottom: 26}}>
                        <Link href="/login" style={{
                            ...
                            padding: '14px 24px',
                            borderRadius: r,
                            boxShadow: '0 10px 30px rgba(124,108,246,.4)'
                        }} className="hover:brightness-110 hover:-translate-y-px transition-all">
                            Start free →
                        </Link>
                        <Link href="/login" style={{
                            display: 'inline-flex',
                ...
                <div className="animate-floaty" style={{flex: 1, minWidth: 392}}>
                    <div style={{
                        ...
                        borderRadius: 18,
                        background: `linear-gradient(180deg,${surface},#101019)`,
                        ...
                        <div style={{
                            ...
                            {[
                                {
                                    title: 'Backlog',
                                    dot: '#7a7a90',
                                    cards: ['User auth flow', 'Mobile nav redesign', 'Dark mode toggle'],
                                    done: false
                                },
                                {
                                    title: 'In Progress',
                                    dot: accent,
                                    cards: ['Presence indicators', 'Drag & drop cards'],
                                    done: false,
                                    live: 1
                                },
                                {title: 'Review', dot: '#f5b836', cards: ['Realtime sync engine'], done: false},
                                {
                                    title: 'Done',
                                    dot: green,
                                    cards: ['Database schema', 'CI/CD pipeline', 'API rate limiting'],
                                    done: true
                                },
                            ].map((col) => (
                                <div key={col.title}>
                                    ...
                                    {col.cards.map((card, ci) => (
                                        <div key={card} style={{
                                            ...
                                            padding: '9px 10px',
                                            fontSize: 11.5,
                                            color: col.done ? '#9a9aae' : '#d6d6e2',
                                            marginBottom: ci < col.cards.length - 1 ? 8 : 0
                                        }}>
                                            {card}
                                            {col.live === ci && (
                            ...
                            {/* Dragged card */}
                            <div className="animate-drag-loop"
                                 style={{position: 'absolute', left: 18, top: 54, width: 148, zIndex: 6}}>
                                <div style={{
                                    background: '#212130',
                                    ...
                                    fontSize: 11.5,
                                    color: '#fff',
                                    boxShadow: `0 16px 34px rgba(0,0,0,.6),0 0 0 3px rgba(124,108,246,.18)`
                                }}>
                                    Realtime sync engine
                                </div>
                                {/* Cursor Ana */}
                                <div style={{position: 'absolute', left: 118, top: 20}}>
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill={accentBright}
                            ...
                            {/* Cursor Marco */}
                            <div className="animate-drift2"
                                 style={{position: 'absolute', right: 42, top: 120, zIndex: 5}}>
                        ...
                        <div style={{
                            ...
                            Ana moved <strong style={{color: muted2, fontWeight: 600, margin: '0 3px'}}>Realtime sync
                            engine</strong> · synced in 38ms
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section style={{
                ...
                <p style={{
                    ...
                    color: dimmed,
                    marginBottom: 22
                }}>Trusted by fast-moving teams</p>
                <div style={{
                    display: 'flex',
                    flexWrap: 'wrap',
                    alignItems: 'center',
            ...
            <section id="features" style={{
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', gap: 18}}>
                    {[
                        {
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={accentBright}
                        ...
                        {
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={green}
                                       strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M5 9h4v11H5zM15 4h4v16h-4z"/>
                                <path d="M9 14h6"/>
                            </svg>,
                        ...
                        {
                            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f5b836"
                                       strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div key={title} style={{
                            flex: 1,
                            minWidth: 280,
                            background: `linear-gradient(180deg,${surface2},#101017)`,
            ...
            <section id="live" style={{
                ...
                <div style={{flex: 1, minWidth: 340}}>
                    ...
                    <p style={{fontSize: 16.5, lineHeight: 1.65, color: '#a3a3b6', marginBottom: 26, maxWidth: 460}}>
                        Every cursor, comment and status change streams in real time. The activity feed keeps a running
                        history so nobody misses a beat — even across time zones.
                    </p>
                    <div style={{display: 'flex', flexDirection: 'column', gap: 14}}>
                        {['Live cursors & selections', 'Threaded comments on any card', 'Full activity history & undo'].map(item => (
                            <div key={item}
                                 style={{display: 'flex', alignItems: 'center', gap: 11, fontSize: 15, color: muted2}}>
                                <span style={{
                                    width: 18,
                                    height: 18,
                                    borderRadius: 5,
                ...
                3 online
                        ...
                        <div style={{display: 'flex', flexDirection: 'column', gap: 11}}>
                            {[
                                {
                                    l: 'A',
                                    grad: 'linear-gradient(135deg,#f2734d,#f5b252)',
                                    name: 'Ana',
                                    action: 'moved',
                                    item: 'Realtime sync engine',
                                    itemColor: accentBright,
                                    ctx: 'to Review',
                                    time: 'just now',
                                    cls: 'animate-toast-in'
                                },
                                {
                                    l: 'M',
                                    grad: 'linear-gradient(135deg,#4d8df6,#7c6cf6)',
                                    name: 'Marco',
                                    action: 'commented on',
                                ...
                                {
                                    l: 'J',
                                    grad: 'linear-gradient(135deg,#22c79a,#5ff0c5)',
                                    name: 'Jana',
                                    action: 'completed',
                                ...
                                <div key={name} className={cls}
                                    ...
                                    <div style={{fontSize: 13.5, color: '#c4c4d2', lineHeight: 1.45}}>
                                        <strong
                                            style={{color: '#fff', fontWeight: 600}}>{name}</strong>{' '}{action}{' '}
                        ...
                        <div style={{
                            ...
                            <input disabled placeholder="Write a comment…" style={{
                                flex: 1,
            ...
            <section id="pricing" style={{
                ...
                <div style={{textAlign: 'center', marginBottom: 50}}>
                    ...
                    <h2 style={{
                        ...
                        fontSize: 'clamp(30px,3.6vw,44px)',
                        letterSpacing: '-.025em'
                    }}>Start free. Scale when you&apos;re ready.</h2>
                </div>
                <div style={{display: 'flex', flexWrap: 'wrap', gap: 18, alignItems: 'stretch'}}>
                    ...
                    <div style={{
                        ...
                        <p style={{fontSize: 13.5, color: '#8a8a9e', marginBottom: 18}}>For small teams getting
                            started.</p>
                        ...
                        <div style={{
                            ...
                            {['Up to 5 boards', 'Up to 5 members', 'Real-time sync', '7-day history'].map(f => (
                                <div key={f} style={{display: 'flex', gap: 9}}><span style={{color: green}}>✓</span>{f}
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div style={{
                        flex: 1,
                        minWidth: 270,
                        background: 'linear-gradient(180deg,#1a1726,#121018)',
                        border: `1px solid ${accent}`,
                        borderRadius: r,
                        padding: 30,
                        position: 'relative',
                        boxShadow: '0 24px 60px rgba(124,108,246,.22)'
                    }}>
                        <span style={{
                            position: 'absolute',
                            top: -11,
                        ...
                        <p style={{fontSize: 13.5, color: '#a3a3b6', marginBottom: 18}}>For growing teams that ship
                            fast.</p>
                        <div style={{marginBottom: 22}}>
                            <span style={{
                                fontFamily: 'var(--font-space-grotesk)',
                        ...
                        <Link href="/login" style={{
                            ...
                            fontSize: 14.5,
                            marginBottom: 22,
                            boxShadow: '0 8px 24px rgba(124,108,246,.4)'
                    ...
                    <div style={{
                        ...
                        <a href="mailto:hello@syncboard.app" style={{
                            display: 'block',
                            textAlign: 'center',
                            padding: 11,
                            borderRadius: `calc(${r} - 3px)`,
            ...
            {/* ── FINAL CTA ───────────────────────────────────────── */}
            <section
                style={{position: 'relative', zIndex: 1, maxWidth: 1100, margin: '60px auto 0', padding: '0 28px'}}>
                <div style={{
                    position: 'relative',
                    overflow: 'hidden',
                    border: '1px solid rgba(124,108,246,.3)',
                    borderRadius: 24,
                    background: 'linear-gradient(135deg,#191428,#100e18)',
                    padding: '64px 40px',
                    textAlign: 'center'
                }}>
                    <div style={{
                        ...
                        width: 600,
                        height: 400,
                        background: 'radial-gradient(50% 50% at 50% 50%,rgba(124,108,246,.3),transparent 70%)',
                        pointerEvents: 'none'
                    }}/>
                    <h2 style={{
                        position: 'relative',
                    ...
                    <Link href="/login" style={{
                        ...
                        padding: '15px 30px',
                        borderRadius: r,
                        boxShadow: '0 12px 34px rgba(124,108,246,.45)'
                    }} className="hover:brightness-110 hover:-translate-y-px transition-all">
                        Start free →
                    </Link>
                </div>
            ...
            <footer style={{
                ...
                <div style={{maxWidth: 280}}>
                    ...
                    <p style={{fontSize: 13.5, lineHeight: 1.6, color: '#8a8a9e'}}>Real-time Kanban for teams that move
                        together.</p>
                </div>
                <div style={{display: 'flex', gap: 64, flexWrap: 'wrap'}}>
                    {[
                        ...
                        {
                            label: 'Company',
                            links: [{text: 'About', href: '#'}, {text: 'Blog', href: '#'}, {text: 'Careers', href: '#'}]
                        },
                        {
                            label: 'Legal',
                            links: [{text: 'Privacy', href: '#'}, {text: 'Terms', href: '#'}, {
                                text: 'Security',
                                href: '#'
                            }]
                        },
                        ...
                        <div key={label} style={{display: 'flex', flexDirection: 'column', gap: 11}}>
                            ...
                            {links.map(({text, href}) => (
                                <a key={text} href={href} style={{fontSize: 14, color: '#b6b6c6'}}
